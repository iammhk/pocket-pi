...
def main(disp):
    ...
    try:
        ...
        try:
            ...
            draw.text((10, 30), "CAMERA ERROR", fill="red")
            draw.text((10, 50), "Library missing", fill="white")
            draw.text((10, 70), "Please run:", fill="gray")
            draw.text((10, 85), "sudo apt install", fill="cyan")
            draw.text((10, 100), "python3-picamera2", fill="cyan")
            draw.text((10, 115), "K3: EXIT", fill="yellow")
            disp.display(img)
